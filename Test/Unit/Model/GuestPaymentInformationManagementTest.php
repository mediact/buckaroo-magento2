...
use TIG\Buckaroo\Model\GuestPaymentInformationManagement;

class GuestPaymentInformationManagementTest extends BaseTest
{
    protected $instanceClass = GuestPaymentInformationManagement::class;
